...
class MultiInterferenceYukawa(PhysicsModelBase_NiceSubclasses):
    def __init__(self):
        ...
        self.printonce = True
        super(MultiInterferenceYukawa, self).__init__()
    ...
    def setPhysicsOptions(self, physOptions):
        ...
        super(MultiInterferenceYukawa, self).setPhysicsOptions(physOptions)
    ...
    def processPhysicsOptions(self, physOptions):
        ...
        return processed + super(MultiInterferenceYukawa, self).processPhysicsOptions(physOptions)
    ...
    def doParametersOfInterest(self):
        ...
        if self.nor:
            ...
            raise ValueError("r with Yukawa")
...
multiInterferenceYukawa = MultiInterferenceYukawa()
