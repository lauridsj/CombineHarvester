...
submit_help_messages = {
    ...
    "or 'random', which runs over random points around the best fit value of each scenario.",
    ...
    "the first value denotes the number of points to run, second and third the interval of those point from best fit g, uniformly sampled.",
