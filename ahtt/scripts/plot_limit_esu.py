...
def draw_1D(onames, limits, labels, xaxis, yaxis, ltitle, gcurve, interpolate, drawband, observed, formal, cmsapp, luminosity, a343bkg, transparent):
    ...
    if not hasattr(draw_1D, "colors"):
        draw_1D.colors = OrderedDict([
            ...
            (3    , [{"exp2": "#ffcc00", "exp1": "#00cc00", "exp0": "0", "expl": "solid", "obsf": "#0033cc", "obsl": "#0033cc", "alpe": 1., "alpo": 0.25},
            ...
            (4    , [{"exp2": "#ffcc00", "exp1": "#00cc00", "exp0": "0", "expl": "solid", "obsf": "#0033cc", "obsl": "#0033cc", "alpe": 1., "alpo": 0.25},
                     {"exp2": "#ff6699", "exp1": "#ff3366", "exp0": "#cc0033", "expl": "dashed", "obsf": "#ffffff", "obsl": "#cc0033", "alpe": 0.25, "alpo": 0.},
                     {"exp2": "#6699ff", "exp1": "#3366ff", "exp0": "#0033cc", "expl": "dashdot", "obsf": "#ffffff", "obsl": "#0033cc", "alpe": 0.25, "alpo": 0.},
                     {"exp2": "#99ff66", "exp1": "#66ff33", "exp0": "#1E7A00", "expl": (0, (1, 1)), "obsf": "#ffffff", "obsl": "#33cc00", "alpe": 0.25, "alpo": 0.},]),
    ...
    for ii, yy in enumerate(yvalues):
        ...
        label = "Median expected" if labels[ii] == "" else ""
    ...
    handles.insert(2, (mpt.Rectangle((0,0), 0, 0, facecolor="white", edgecolor="white", alpha=0.), ""))
    ...
    legend = ax.legend(first(handles), second(handles),
	               loc = "upper right", ncol = 2, bbox_to_anchor = (lmargin, 1. - lheight, lwidth, lheight - 0.025),
                       mode = "expand", borderaxespad = 0., handletextpad = 0.35, fontsize = 21, frameon = False,
    ...
    yexp = [yv["exp0"] for yv in yvalues]
    save = np.array([xvalues, *yexp]).T
    header = "mass " + " ".join(labels)
    np.savetxt(oname.replace(".pdf", ".txt"), save, fmt='%.5f', header=header)
